...
chrome_driver = "D:/0/Доки/2 сем/Программное обеспечение облачных платформ/PipelinePractice/tests/functional_tests/chromedriver.exe" if "ChromeWebDriver" not in os.environ.keys() else os.path.join(
